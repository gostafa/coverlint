...
func TestCollectRunsGoTestAndParsesProfile(t *testing.T) {
	...
	coverage, err := goToolForTest().Collect(t.Context(), &outbound.CoverageRequest{Patterns: []string{dir}, TestArgs: []string{"-run", "TestAdd"}})
	if err != nil {
...
func TestListReturnsPackageMetadata(t *testing.T) {
	...
	packages, err := goToolForTest().List(t.Context(), &outbound.PackageRequest{
		Patterns: []string{dir},
...
func TestListWrapsGoListFailure(t *testing.T) {
	...
	_, err := goToolForTest().List(t.Context(), &outbound.PackageRequest{Patterns: []string{"./missing"}, TestArgs: nil})
...
func TestOpenRejectsEmptyProfile(t *testing.T) {
	...
	err := goToolForTest().Open(t.Context(), &outbound.HTMLOpenRequest{Profile: nil, Stdout: nil, Stderr: nil})
...
func TestOpenReportsContextCancellation(t *testing.T) {
	...
	err := gotool.New().Open(ctx, &outbound.HTMLOpenRequest{
